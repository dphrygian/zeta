...
// DLP 7 May 2019...: Min volume define
#define SOLOUD_MIN_VOLUME 0.0001f
// ...DLP 7 May 2019
...
namespace SoLoud
{
	...
	public:
		...
		// DLP 27 Nov 2021...: Early mutex to prevent game thread blocking while SoLoud is mixing.
		bool tryLockMixerMutex();	// Returns true if lock was attained, for the game thread
		void lockMixerMutex();		// Blocks until lock is attained, for the SoLoud thread
		void unlockMixerMutex();
		// ...DLP 27 Nov 2021
	};
};

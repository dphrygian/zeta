...
/*virtual*/ void WBPEConditional::Evaluate( const WBParamEvaluator::SPEContext& Context, WBParamEvaluator::SEvaluatedParam& EvaluatedParam ) const
{
	...
	if( m_ConditionalOp == ECO_Equals )
	{
		...
		else if( ValueA.m_Type == WBParamEvaluator::EPT_String || ValueB.m_Type == WBParamEvaluator::EPT_String )
		{
			EvaluatedParam.m_Type	= WBParamEvaluator::EPT_Bool;
			EvaluatedParam.m_Bool	= ValueA.GetString() == ValueB.GetString();
		}
		else if( ValueA.m_Type == WBParamEvaluator::EPT_Entity || ValueB.m_Type == WBParamEvaluator::EPT_Entity )
		{
			EvaluatedParam.m_Type	= WBParamEvaluator::EPT_Bool;
		...
		else if( ValueA.m_Type == WBParamEvaluator::EPT_Angles || ValueB.m_Type == WBParamEvaluator::EPT_Angles )
		{
			EvaluatedParam.m_Type	= WBParamEvaluator::EPT_Bool;
			EvaluatedParam.m_Bool	= ValueA.GetAngles() == ValueB.GetAngles();
		}
		else
		{
			EvaluatedParam.m_Type	= WBParamEvaluator::EPT_Bool;

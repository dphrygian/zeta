...
#define BEGIN_ITERATING_SCENES do{ ++m_IteratingScenesRefCount; } while(0)
#define END_ITERATING_SCENES do{ --m_IteratingScenesRefCount; } while(0)
#define CHECK_ITERATING_SCENES do{ DEVASSERT( 0 == m_IteratingScenesRefCount ); } while(0)
...
,	m_Clock( NULL )
#if BUILD_DEBUG
,	m_IteratingEntitiesRefCount( 0 )
,	m_IteratingScenesRefCount( 0 )
#endif
{
...
{
	// DLP 12 Oct 2021: Reset UID counters so they don't constantly go up during play.
	// I don't think this should be a problem; they can already be reset due to serialization.
	m_NextEntityUID	= 0x1d000000;
	m_NextSceneUID	= 0x5c000000;

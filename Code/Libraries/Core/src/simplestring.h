...
public:
	...
	void			SplitInPlace( uint Index, SimpleString& Left, SimpleString& Right ) const;
	void			SplitInPlaceFind( const char Delimiter, SimpleString& Left, SimpleString& Right ) const;	// Split at the first instance of Delimiter

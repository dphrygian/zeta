...
void Keyboard::Tick( const float DeltaTime )
{
	...
	// HACKHACK for virtual key combos
	m_CurrentState.m_Buttons[ EB_Virtual_Shift ]	= m_CurrentState.m_Buttons[ EB_LeftShift ]		|| m_CurrentState.m_Buttons[ EB_RightShift ];
	m_CurrentState.m_Buttons[ EB_Virtual_Control ]	= m_CurrentState.m_Buttons[ EB_LeftControl ]	|| m_CurrentState.m_Buttons[ EB_RightControl ];
	m_CurrentState.m_Buttons[ EB_Virtual_Alt ]		= m_CurrentState.m_Buttons[ EB_LeftAlt ]		|| m_CurrentState.m_Buttons[ EB_RightAlt ];

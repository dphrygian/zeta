...
/*virtual*/ void SoundInstanceCommon::Tick3D()
{
	...
	// NOTE: This used to be Attenuate, changed to address complaints about hearing distant sounds too clearly
	m_Attenuation						= AttenuateQuad( DistanceToSound, FalloffRadius );

...
// DLP 12 Oct 2021: The comment above is only partially correct.
// This is good for culling, but it does have false positives, when
// the AABB is large compared to the frustum, and spans any two
// planes in different places. Here's an example: point A falls
// inside the left plane, while points B and C fall inside the far
// plane, and we return true when there is actually no intersection.
//
//       \ (left plane)
// x------\A
// |       \

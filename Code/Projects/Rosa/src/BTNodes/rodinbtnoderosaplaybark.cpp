#include "core.h"
#include "rodinbtnoderosaplaybark.h"
#include "configmanager.h"
#include "Components/wbcomprodinbehaviortree.h"
#include "wbeventmanager.h"
#include "animation.h"

RodinBTNodeRosaPlayBark::RodinBTNodeRosaPlayBark()
:	m_SoundDef()
,	m_SoundDefPE()
,	m_Category()
{
...
void RodinBTNodeRosaPlayBark::InitializeFromDefinition( const SimpleString& DefinitionName )
{
...
RodinBTNode::ETickStatus RodinBTNodeRosaPlayBark::Tick( const float DeltaTime )
{
	Unused( DeltaTime );
